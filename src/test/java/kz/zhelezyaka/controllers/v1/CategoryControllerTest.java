...
import kz.zhelezyaka.services.CategoryService;
import kz.zhelezyaka.services.ResourceNotFoundException;
...
public class CategoryControllerTest {
    ...
    public void testGetByNameCategories() throws Exception {
        ...
        mockMvc.perform(get(CategoryController.BASE_URL + "/Vladimir")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
